...
export default function VideoCard(props: VideoCardProps) {
  ...
  return (
    <button
      onClick={handleClick}
      class="group block w-full text-left focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-900 rounded-xl"
    >
      <Card class="h-full">
        <div class="relative aspect-video overflow-hidden bg-dark-600">
          <img src={thumbnailUrl()} alt={props.video.title} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
