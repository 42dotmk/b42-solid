...
abstract class B42Tokens {
  ...
  // color
  static const Color colorPrimaryBase = Color.fromARGB(255, 250, 225, 39);
  static const Color colorPrimaryHover = Color.fromARGB(255, 248, 226, 62);
  static const Color colorPrimaryMuted = Color.fromARGB(26, 250, 225, 39);
  static const Color colorPrimaryGlow = Color.fromARGB(102, 250, 225, 39);
  static const Color colorSecondaryBase = Color.fromARGB(255, 43, 237, 237);
  ...
  static const Color colorBorderDefault = Color.fromARGB(26, 255, 255, 255);
  static const Color colorBorderHover = Color.fromARGB(51, 255, 255, 255);
  static const Color colorSemanticSuccess = Color.fromARGB(255, 34, 197, 94);
  static const Color colorSemanticWarning = Color.fromARGB(255, 245, 158, 11);
